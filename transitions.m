function [ ocupationnumber,MTarryocupation,new_pos,pos,iarraysize,status,tranflag,controldensitynew,lastnonzeromembranes,MTL,new_posMTL,state] = transitions(transitionkind,positiontran,ocupationnumber,MTarryocupation,MTarryocupationtemp,new_pos,pos,iarraysize,...
...
if new_posMTL<new_pos %|| new_pos>new_posMTL
    new_pos=new_posMTL;
end
if new_pos<0
    new_pos=0;

...
void myFind_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  emxArray_real_T *x;
  emxArray_real_T *idx;
...
void myFind_atexit(void)
{
  ...
  myFind_xil_terminate();
}

void myFind_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_myFind_api.c) */
